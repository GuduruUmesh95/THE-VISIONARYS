  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] pointer-events-auto">
      ...
      <button 
        ...
        className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-b from-[#18181b] to-[#0a0a0c] border border-[#FFB84D]/40 rounded-full flex items-center justify-center cursor-pointer shadow-[0_0_30px_rgba(255,184,77,0.2)] hover:border-[#FFB84D] transition-all duration-300 transform hover:scale-105 relative group pointer-events-auto"
      ...
      >
        ...
        <svg viewBox="0 0 100 100" className="w-7 h-7 md:w-8.5 h-8.5 text-[#FFB84D] drop-shadow-[0_2px_8px_rgba(255,184,77,0.3)] transition-colors duration-300" xmlns="http://www.w3.org/2000/svg">
